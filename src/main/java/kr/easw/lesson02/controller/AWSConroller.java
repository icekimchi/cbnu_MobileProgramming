...
import kr.easw.lesson02.model.dto.DownloadFileDto;
...
public class AWSConroller {
    ...
    @GetMapping("/download")
    private ResponseEntity<byte[]> onDownload(@ModelAttribute DownloadFileDto downloadFileDto) throws IOException {
        return awsController.getObject(downloadFileDto.getFileName());
    }
